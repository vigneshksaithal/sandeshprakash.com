...
<main class="min-h-screen">
  ...
  <div class="relative bg-[var(--color-primary)] text-[var(--color-text)] py-24 overflow-hidden">
    <!-- Decorative shapes -->
    <div class="absolute inset-0">
      ...
      <!-- Small circle -->
      <div class="absolute top-1/3 left-1/4 w-[20rem] h-[20rem] rounded-full bg-white/5"></div>

      <!-- Square -->
      <div class="absolute bottom-1/3 right-1/4 w-[25rem] h-[25rem] rotate-45 border border-white/10"></div>
