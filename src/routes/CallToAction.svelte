    ...
    <div class="absolute inset-0">
        ...
        <div 
            ...
            style="background-image: repeating-linear-gradient(0deg, var(--color-text), var(--color-text) 1px, transparent 1px, transparent 20px);
                   ...
                   transform: translate3d({mouseX * 0.5}px, {mouseY * 0.5}px, 0) rotate(30deg)"
        ></div>
    </div>
    ...
    <div class="container mx-auto px-6 md:px-16 relative">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <p class="text-xl text-white/80 mb-12 font-light max-w-2xl mx-auto leading-relaxed">
                From warehouses to manufacturing facilities, offices to industrial land - we're your trusted partner in finding, acquiring, or leasing the perfect commercial property in Bengaluru.
            </p>
            ...
            <div class="flex flex-col sm:flex-row justify-center items-center gap-6">
                <a href="/contact" 
                   class="group relative px-8 py-4 bg-white text-[var(--color-primary)] rounded-full overflow-hidden transition-all duration-500 hover:scale-105 hover:shadow-2xl w-full sm:w-auto">
                    ...
                    <span class="relative font-semibold text-lg group-hover:text-white">Contact Us (Free Consultation)</span>
                </a>
